                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                    {djs.map((dj, i) => (
                        <ScrollAnimation 
                            key={dj.name} 
                            delay={i * 0.1}
                            className={i === 2 ? "col-span-1 sm:col-span-2" : ""}
                        >
                            <Card className="p-4 md:p-8 rounded-2xl md:rounded-3xl border-white/20 bg-white/10 backdrop-blur-sm transition-all hover:bg-white/15">
